...
<head>
    ...
    <h2 align="center">My Personal Movie DataBase <a href="../../index.php">| FRONTPAGE |</a></h2></head>
...
<div class="around">
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        $year=$row['year'];
        $review=$row['review'];
        $picture="../posters/".$row['picture'];
        //$rating=$row['rating'];
        echo"<div class='sideBySide'>
        <div class='frame'>
            <div class='movie' >".$movie."</div>
                <img id='myImg' src='$picture' alt='$review' style='height: 450px; width: 300px;'>
            <div>".$genre." (".$year.")</div>
        </div>
    </div>";
    }
...
<footer class="footer" style="color: white; text-align: right;">| est.2017 | folafsson |</footer>
</html>
